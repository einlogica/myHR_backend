...
class call_api{
    ...
    public function markAbsent(){
        ...
        $query = "UPDATE `Attendance` SET PosLat=0.0,PosLong=0.0,InTime='00:00:00',PosLat2=0.0,PosLong2=0.0,OutTime='00:00:00',Status='Absent' WHERE Mobile='$usermobile' AND Date='$date'";
        $stm = $this->conn->prepare($query);
        if($stm->execute()){
            return "Success";
        }
